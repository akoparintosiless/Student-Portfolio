...
This activity builds on Activity #1 by using analogWrite() to control LED brightness and implementing logic with arrays and loops.
...
Upload the provided sketch to your Arduino to demonstrate PWM analog control on multiple LEDs.
